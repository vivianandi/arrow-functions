...
let Student = function Student(name, age, hometown) {
  this.name = name;
  this.age = age;
...
//this refers to the joe object itself -> this represents the instance of the Student object (joe)
// 2. What is "this" when joe.scopeArrow() is invoked?
//this refers to the global object
// 3. Explain why "this" is different when an arrow function is used.
//The reason why this is different when an arrow function is used is because arrow functions do not have their own this context. Instead, they inherit this.